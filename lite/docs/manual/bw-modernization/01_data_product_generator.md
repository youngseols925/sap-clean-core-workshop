...
[📸 스크린샷: BW Cockpit — ZCASHACT DataStore 조회 화면]
...
[📸 스크린샷: Data Product Generator — Data Subscription 생성 화면]
...
[📸 스크린샷: Data Subscription 실행 결과 — 전송된 레코드 수]
...
[📸 스크린샷: Datasphere Data Builder — DDS_... 테이블 데이터 미리보기]
