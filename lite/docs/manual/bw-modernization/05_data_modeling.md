...
[📸 스크린샷: Data Builder → New Graphical View 타일]

**Data Builder** → 내 스페이스 선택 → **New Graphical View** 클릭

### Step 2 · BW 실적 데이터 소스 추가

[📸 스크린샷: Repository 탭 검색 — ZCASHACT]
...
[📸 스크린샷: Rename 완료된 Projection 노드 컬럼 목록]
...
[📸 스크린샷: TO_DATE 표현식 입력 및 Validate 결과]

---

### Step 6 · UNION으로 두 소스 결합

[📸 스크린샷: Calculated Columns 1 노드를 Projection 1 위에 드롭 → Union 선택]
...
[📸 스크린샷: Fact View 속성 — Measures 4개 + Attributes 4개]
...
[📸 스크린샷: Data Viewer — 실적(CASHFLOW_ACTUAL) + 예측(CASHFLOW_FORECAST) 레코드]
...
[📸 스크린샷: Analytic Model 에디터 — Fact View + Time Dimension 자동 연결]
...
[📸 스크린샷: AM Preview — COMPANYCODE별 CASHFLOW_ACTUAL + CASHFLOW_FORECAST]
