...
[📸 스크린샷: SAP Analytics Cloud 메인 화면]
...
[📸 스크린샷: Stories → CashFlowForecast Template 선택]
...
[📸 스크린샷: Filters 탭 — Add New Filter → Year]
...
[📸 스크린샷: 왼쪽 '+' Numeric Point Chart 플레이스홀더 클릭]
...
[📸 스크린샷: Cash Flow Actual KPI → More Actions → Duplicate]
...
[📸 스크린샷: Time Series Chart 플레이스홀더 클릭]
...
[📸 스크린샷: 완성된 Time Series Chart — 실선(실적) + 점선(예측)]
