...
[📸 스크린샷: SAP Databricks Welcome 화면]
...
[📸 스크린샷: zcashflow 테이블 — Sample Data 탭]
...
[📸 스크린샷: MLflow — 회사 코드별 실험 결과 (Color-coded 차트)]
...
[📸 스크린샷: Catalog — cashflow_forecast → Share → Share via Delta Sharing]
...
[📸 스크린샷: Delta Sharing — Shared by me 탭]
...
[📸 스크린샷: Datasphere Catalog — cashflow forecast data product 검색 결과]
